                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label
                                            class="title-color d-flex">{{\App\CPU\translate('first')}} {{\App\CPU\translate('name')}}</label>
                                        <input type="text" value="{{$delivery_man['f_name']}}" name="f_name"
                                               class="form-control"
                                               placeholder="{{\App\CPU\translate('New delivery-man')}}"
                                               required>
                                    </div>

                                    <div class="form-group">
                                        <label
                                            class="title-color d-flex">{{\App\CPU\translate('last')}} {{\App\CPU\translate('name')}}</label>
                                ...
                                <div class="col-md-6 col-12">
                                    <div class="form-group">
                                        <label
                                            class="title-color d-flex">{{\App\CPU\translate('identity')}} {{\App\CPU\translate('type')}}</label>
                                        <select name="identity_type" class="form-control">
                                            ...
                                            <option
                                                value="nid" {{$delivery_man['identity_type']=='nid'?'selected':''}}>{{\App\CPU\translate('nid')}}
                                            </option>
                                            <option
                                    ...
                                    <div class="form-group">
                                        <label
                                            class="title-color d-flex">{{\App\CPU\translate('identity')}} {{\App\CPU\translate('number')}}</label>
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <center>
                                            <img class="upload-img-view" id="viewer"
                                                 src="{{Storage::url('/delivery-man').'/'.$delivery_man['image']}}"
                                ...
                                <div class="col-md-6 col-12">
                                    ...
                                    <div class="form-group">
                                        <label
                                            class="title-color d-flex">{{\App\CPU\translate('identity')}} {{\App\CPU\translate('image')}}</label>
                                        <div>
                                            <div class="row" id="coba">
                                                @foreach(json_decode($delivery_man['identity_image'],true) as $img)
                                                    <div class="col-md-4 mb-3">
                                                        <img height="150"
                                                             src="{{Storage::url('/delivery-man').'/'.$img}}">
                                                    </div>
                                                @endforeach
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="password" class="form-control"
                                               placeholder="{{\App\CPU\translate('Ex : password')}}">
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label
                                            class="title-color d-flex">{{\App\CPU\translate('confirm_password')}}</label>
