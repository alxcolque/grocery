                        ...
                        <div>
                            <select class="form-control" name="rating">
                                <option value="" selected>
                                    --{{ \App\CPU\translate('Select_Rating') }}--
                                </option>
                                <option
                                    value="1" {{ $rating==1 ? 'selected': '' }}>{{ \App\CPU\translate('1') }}</option>
                                <option
                                    value="2" {{ $rating==2 ? 'selected': '' }}>{{ \App\CPU\translate('2') }}</option>
                                <option
                                    value="3" {{ $rating==3 ? 'selected': '' }}>{{ \App\CPU\translate('3') }}</option>
                                <option
                                    value="4" {{ $rating==4 ? 'selected': '' }}>{{ \App\CPU\translate('4') }}</option>
                                <option
                                    value="5" {{ $rating==5 ? 'selected': '' }}>{{ \App\CPU\translate('5') }}</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-md-2">
                                   ...
                                   href="{{route('admin.customer.view',[$review['customer_id']])}}">
                                    <div class="avatar avatar-circle">
                                        <img
                                            class="avatar-img"
                                            onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                            src="{{Storage::url('/profile/'.$review->customer->image)}}"
                                            alt="Image Description">
                                    </div>
                                ...
                                <div class="text-wrap">
                                    ...
                                    <div class="content p-0">
                                        @if(strlen($review['comment']) > 200))
                                            ...
                                            <span id="show-more-{{$review->id}}" data-id="{{$review->id}}" onclick="toggle_btn(this)">...<a href="javascript:void(0)">{{ \App\CPU\translate('show_more') }}</a></span>

                                            <span id="show-more-content-{{$review->id}}" class="show-more-content">
                                            {{substr($review['comment'], 200)}}
                                            <span id="show-less-{{$review->id}}" data-id="{{$review->id}}" onclick="toggle_btn(this)"><a href="javascript:void(0)">{{ \App\CPU\translate('show_less') }}</a></span>
                                        @else
                                            {{ $review['comment'] }}
                                        @endif
                                    </div>
