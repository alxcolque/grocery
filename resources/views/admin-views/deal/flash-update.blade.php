                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 mt-4">
                                    <center>
                                        <img class="border radius-10" height="200" id="viewer"
                                        onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'" src="{{Storage::url('/deal')}}/{{$deal['banner']}}" alt="banner image"/>
                                    </center>
                                </div>
                            </div>
                        </div>
