                ...
                <div class="row align-items-md-center gx-md-5">
                    ...
                    <div class="col-lg-4 mb-5 mb-lg-0 d-flex flex-column gap-1">
                        ...
                        @if(($product->product_type == 'digital') && ($product->digital_product_type == 'ready_product'))
                            <div>
                                <a href="{{Storage::url("/product/digital-product/$product->digital_file_ready")}}" class="btn btn--primary py-1 mt-3" download>{{\App\CPU\translate('download')}}</a>
                            </div>
                        @endif
                                    ...
                                    <div class="col-6 col-md-4 col-lg-3">
                                        <div class="card">
                                            <div class="card-body">
                                                <img class="width-100"
                                                    onerror="this.src='{{asset('public/assets/front-end/img/image-place-holder.png')}}'"
                                                    src="{{Storage::url("/product/$photo")}}" alt="Product image">
                            ...
                            <td>
                                <div class="text-wrap">
                                    ...
                                    @foreach (json_decode($review->attachment) as $img)
                                        ...
                                        <a class="float-left" href="{{Storage::url('/review')}}/{{$img}}" data-lightbox="mygallery">
                                            <img class="p-2" width="60" height="60" src="{{Storage::url('/review')}}/{{$img}}" alt="">
                                        </a>
