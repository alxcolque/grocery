                ...
                <div class="navbar-brand-wrapper justify-content-between side-logo">
                    ...
                    <a class="navbar-brand" href="{{ route('admin.dashboard.index') }}" aria-label="Front">
                        <img onerror="this.src='{{ asset('public/assets/back-end/img/900x400/img1.jpg') }}'"
                            ...
                            src="{{ Storage::url("/company/$e_commerce_logo") }}" alt="Logo">
                    </a>
                ...
                <div class="navbar-vertical-content">
                    ...
                    <ul class="navbar-nav navbar-nav-lg nav-tabs">
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('product_management'))
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/product/list/in_house') || Request::is('admin/product/bulk-import') || Request::is('admin/product/add-new') || Request::is('admin/product/view/*') || Request::is('admin/product/barcode/*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/product/list/in_house') || Request::is('admin/product/add-new') || Request::is('admin/product/view/*') || Request::is('admin/product/barcode/*') ? 'active' : '' }}">
                                        <a class="nav-link "
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('promotion_management'))
                            ...
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="navbar-vertical-aside-has-menu {{ Request::is('admin/deal/feature') || Request::is('admin/deal/edit*') ? 'active' : '' }}">
                                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('report'))
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/report/earning') || Request::is('admin/report/inhoue-product-sale') || Request::is('admin/report/seller-product-sale') || Request::is('admin/report/earning') || Request::is('admin/transaction/list') || Request::is('admin/refund-section/refund-list') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                    href="javascript:"
                                    title="{{ \App\CPU\translate('Sales_&_Transaction_Report') }}">
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        ...
                                        <a class="js-navbar-vertical-aside-menu-link nav-link"
                                            ...
                                            <span
                                                class="navbar-vertical-aside-mini-mode-hidden-elements text-truncate">
                                                {{ \App\CPU\translate('Earning') }}
                                                {{ \App\CPU\translate('Statistics') }}
                                            </span>
                                        </a>
                                    </li>
                                    <li
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('user_section'))
                            <li
                                class="nav-item {{ Request::is('admin/customer/list') || Request::is('admin/sellers/subscriber-list') || Request::is('admin/sellers/seller-add') || Request::is('admin/sellers/seller-list') || Request::is('admin/delivery-man*') ? 'scroll-here' : '' }}">
                                <small class="nav-subtitle"
                                    title="">{{ \App\CPU\translate('user_management') }}</small>
                                <small class="tio-more-horizontal nav-subtitle-replacer"></small>
                            </li>
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        ...
                                        <a class="nav-link " href="{{ route('admin.customer.list') }}"
                                            ...
                                            <span class="tio-circle nav-indicator-icon"></span>
                                            <span class="text-truncate">{{ \App\CPU\translate('Customer_List') }}
                                            </span>
                                        </a>
                                    </li>
                            ...
                            <li
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/delivery-man/list') || Request::is('admin/delivery-man/earning-statement*') || Request::is('admin/delivery-man/earning-active-log*') || Request::is('admin/delivery-man/order-wise-earning*') ? 'active' : '' }}">
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/delivery-man/chat') ? 'active' : '' }}">
                        ...
                        @if (\App\CPU\Helpers::module_permission_check('system_settings'))
                            <li
                                class="nav-item {{ Request::is('admin/business-settings/social-media') || Request::is('admin/business-settings/web-config/app-settings') || Request::is('admin/business-settings/terms-condition') || Request::is('admin/business-settings/privacy-policy') || Request::is('admin/business-settings/about-us') || Request::is('admin/helpTopic/list') || Request::is('admin/business-settings/fcm-index') || Request::is('admin/business-settings/mail') || Request::is('admin/business-settings/web-config/db-index') || Request::is('admin/business-settings/web-config/environment-setup') || Request::is('admin/business-settings/web-config') ? 'scroll-here' : '' }}">
                                <small class="nav-subtitle"
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/business-settings/web-config') || Request::is('admin/business-settings/web-config/app-settings') || Request::is('admin/product-settings/inhouse-shop') || Request::is('admin/business-settings/seller-settings') || Request::is('admin/customer/customer-settings') || Request::is('admin/refund-section/refund-index') || Request::is('admin/business-settings/shipping-method/setting') || Request::is('admin/business-settings/order-settings/index') || Request::is('admin/product-settings') || Request::is('admin/business-settings/web-config/delivery-restriction') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link"
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/business-settings/mail') || Request::is('admin/business-settings/sms-module') || Request::is('admin/business-settings/captcha') || Request::is('admin/social-login/view') || Request::is('admin/business-settings/map-api') || Request::is('admin/business-settings/payment-method') || Request::is('admin/business-settings/fcm-index') ? 'active' : '' }}">
                            ...
                            <li
                                class="navbar-vertical-aside-has-menu {{ Request::is('admin/business-settings/terms-condition') || Request::is('admin/business-settings/privacy-policy') || Request::is('admin/business-settings/about-us') || Request::is('admin/helpTopic/list') || Request::is('admin/business-settings/social-media') || Request::is('admin/file-manager*') ? 'active' : '' }}">
                                <a class="js-navbar-vertical-aside-menu-link nav-link nav-link-toggle"
                                ...
                                <ul class="js-navbar-vertical-aside-submenu nav nav-sub"
                                    ...
                                    <li
                                        class="nav-item {{ Request::is('admin/business-settings/terms-condition') || Request::is('admin/business-settings/privacy-policy') || Request::is('admin/business-settings/about-us') || Request::is('admin/helpTopic/list') ? 'active' : '' }}">
                                        <a class="nav-link"
