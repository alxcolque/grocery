        ...
        <div class="d-flex align-items-center justify-content-center active">
            <img class="img-responsive rounded"
                src="{{Storage::url('/product/thumbnail')}}/{{$product->thumbnail}}"
                 ...
                 data-zoom="{{Storage::url('/product')}}/{{$product['image']}}"
                 alt="Product image" height="100">
            <div class="cz-image-zoom-pane"></div>
        </div>
        <!-- Product details-->
        <div class="details media-body">
            <h4 class="mb-3 product-title">{{ Str::limit($product->name, 26) }}</h4>
        ...
        <div class="col-12">
            ...
            <form id="add-to-cart-form">
                ...
                @foreach (json_decode($product->choice_options) as $key => $choice)
                    ...
                    <h5 class="p-0 pt-2">{{ $choice->title }}
                    </h5>
                    ...
                    <div class="product-quantity d-flex align-items-center">
                        <div class="d-flex align-items-center">
                            <span class="product-quantity-group">
                                <button class="btn-number" type="button"
                ...
                <div class="row no-gutters mt-2 text-dark" id="chosen_price_div">
                    <div class="col-2">
                        <div class="product-description-label font-weight-bold">{{\App\CPU\translate('Total Price')}}:</div>
                    </div>
                    <div class="col-10">
