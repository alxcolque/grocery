            ...
            <div class="col-lg-9">
                ...
                <!-- Card -->
                    <div class="card mb-3 mb-lg-5" id="generalDiv">
                        ...
                        @php($shop_banners = $shop_banner ? Storage::url('/shop/banner/'.$shop_banner) : 'https://images.pexels.com/photos/866398/pexels-photo-866398.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1')
                        ...
                        <label
                            ...
                            <img id="viewer"
                                 ...
                                 class="avatar-img"
                                 src="{{Storage::url('/seller')}}/{{$data->image}}"
                                 alt="Image">
                        </label>
                        <!-- End Avatar -->
                    </div>
