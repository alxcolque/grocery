...
@push('css_or_js')
    <meta property="og:image" content="{{Storage::url('/company')}}/{{$web_config['web_logo']->value}}"/>
    <meta property="og:title" content="Welcome To {{$web_config['name']->value}} Home"/>
    <meta property="og:url" content="{{env('APP_URL')}}">
    <meta property="og:description" content="{!! substr($web_config['about']->value,0,100) !!}">

    <meta property="twitter:card" content="{{Storage::url('/company')}}/{{$web_config['web_logo']->value}}"/>
            ...
            <div class="owl-carousel owl-theme p-2" id="brands-slider">
                @foreach($brands as $brand)
                    <div class="text-center">
                        <a href="{{route('products',['id'=> $brand['id'],'data_from'=>'brand','page'=>1])}}" class="__brand-item">
                            <img onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'" src="{{Storage::url("/brand/$brand->image")}}" alt="{{$brand->name}}">
                        </a>
                    </div>
                @endforeach
            </div>
                    ...
                    @if(isset($deal_of_the_day) && isset($deal_of_the_day->product))
                        ...
                        <div class="recomanded-product-card">
                            ...
                            <div class="d-flex justify-content-center align-items-center __pt-20 __m-20-r">
                                <img class="__rounded-top" src="{{\App\CPU\ProductManager::product_image_path('thumbnail')}}/{{$deal_of_the_day->product['thumbnail']}}"
            ...
            <div class="col-xl-9 col-md-8 mt-2">
                <div class="latest-product-margin">
                    <div class="d-flex justify-content-between">
                        <div class="text-center">
                            <span class="for-feature-title __text-22px font-bold text-center">{{ \App\CPU\translate('latest_products')}}</span>
                        </div>
                        <div class="mr-1">
            ...
            <div class="col-12 pl-0 pr-0">
                <a href="{{$main_section_banner->url}}"
                    ...
                    <img class="d-block footer_banner_img __inline-63" onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                            src="{{Storage::url('/banner')}}/{{$main_section_banner['photo']}}">
                </a>
            </div>
        </div>
    </div>
                                        ...
                                        <a href="{{route('products',['id'=> $category['id'],'data_from'=>'category','page'=>1])}}">
                                            <div class="__img">
                                                <img onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                                    src="{{Storage::url("/category/$category->icon")}}"
                                                    alt="{{$category->name}}">
                                            </div>
                                        ...
                                        @if($seller->shop)
                                            <div class="__m-5px __cate-item">
                                                <a href="{{route('shopView',['id'=>$seller['id']])}}">
                                                    ...
                                                    <img onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                                        src="{{Storage::url("/shop")}}/{{$seller->shop->image}}">
                                                    </div>
                ...
                <div class="row mt-2 justify-content-between g-3">
                    <div class="col-md-3 col-12">
                        <a href="{{route('products',['id'=> $category['id'],'data_from'=>'category','page'=>1])}}" class="cursor-pointer d-block h-100 __cate-product-side-img">
                             <img class="h-100" onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                  src="{{Storage::url('/category')}}/{{$category['icon']}}">
                         </a>
                    </div>
