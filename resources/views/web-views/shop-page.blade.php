...
@push('css_or_js')
    @if($shop['id'] != 0)
        <meta property="og:image" content="{{Storage::url('/shop')}}/{{$shop->image}}"/>
        <meta property="og:title" content="{{ $shop->name}} "/>
        <meta property="og:url" content="{{route('shopView',[$shop['id']])}}">
    @else
        <meta property="og:image" content="{{Storage::url('/company')}}/{{$web_config['fav_icon']->value}}"/>
        <meta property="og:title" content="{{ $shop['name']}} "/>
        <meta property="og:url" content="{{route('shopView',[$shop['id']])}}">
    @endif
                ...
                <div class="bg-white">
                    @if($shop['id'] != 0)
                        <img class="__shop-page-banner"
                             src="{{Storage::url('/shop/banner')}}/{{$shop->banner}}"
                            ...
                            <div class="">
                                @if($shop['id'] != 0)
                                    <img class="__inline-68"
                                         src="{{Storage::url('/shop')}}/{{$shop->image}}"
                                         onerror="this.src='{{asset('assets/front-end/img/image-place-holder.png')}}'"
                                         alt="">
                                @else
                                    <img class="__inline-68"
